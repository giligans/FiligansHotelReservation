...
<div class="modal fade" id="updateModal" style='z-index:10000'>
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
				<button type="button" class="btn btn-primary" ng-click='saveChanges()' ng-disabled='updateBooking.status==5 && updateBooking.cancelled_remarks==null || updateBooking.cancelled_remarks==""'>Save changes</button>
			</div>
		</div><!-- /.modal-content -->
	</div><!-- /.modal-dialog -->
</div><!-- /.modal -->
...
<div class="page-header" style='margin-top:-20px'>
	<h2 style='font-family:Open Sans;'>Cancelled bookings today</h2>
</div>
<ol class="breadcrumb">
	<li>
		<a href="#">Dashboard</a>
