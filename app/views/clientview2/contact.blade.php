...
<div class="row" style='padding:10px'>
	<h2 style="font-family: 'Oswald', sans-serif;">Contact</h2>

	<hr style='border-top:2px solid #d8d8d8;'>
	Giligans Hotel is less than 10 minutes
...
<div class="row">
	...
	<div class="col-sm-8 contact-form">
		<form id="contact" method="post" class="form" role="form" style='margin-top:20px;'>
			<div class="row">
